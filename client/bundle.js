...
__vue__options__._scopeId = "data-v-65616d6b"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.dispose(__vueify_style_dispose__)
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f9e5a0de", __vue__options__)
  } else {
    hotAPI.reload("data-v-f9e5a0de", __vue__options__)
  }
})()}
